...
class algorithmthread(Thread):
    ...
    def __init__(self,w,template,ldaW,datalocker,addloop,eye_decide_result):
        ...
        self.controlCenterAddr = ('192.168.213.93', 40007)                       # ('127.0.0.1',8847)
        self.resultPtr = 0
    ...
    def resultDecide(self):
        ...
        if ldaP[0,0]<=ldaP[0,1]:
            ...
            eye_decide_result = char[self.eye_track_result.value]
            brain_decide_result = char[self.sendresult]

            command = brain_decide_result + eye_decide_result
